...
import { setSearchedQuery } from "@/redux/jobSlice";
import { RootState } from "@/redux/app/store";
import { Loader2 } from "lucide-react"; // Import the spinning loader from lucide-react
...
const Home: React.FC = () => {
  ...
  // Simulate content loading (this can be replaced with actual data fetching logic)
  useEffect(() => {
    setTimeout(() => {
      setLoading(false); // Set loading to false after content is loaded (or after data fetching completes)
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      {/* Loading spinner - shows before the content is loaded */}
      {loading && (
