...
//   const logoutHandler = () => {
//     dispatch(logout()); // Use the new logout action from your Redux slice
//     navigate('/login');
//   };
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white shadow-md dark:bg-gray-900">
      <div className="container flex items-center justify-between px-6 py-4 mx-auto">
        ...
        {/* User Profile and Mobile Menu Button Container */}
        <div className="flex items-center space-x-4">
          {/* Login/Signup Buttons (Desktop & Mobile) */}
          {!user ? (
            <>
              <Button variant="outline" className="hidden sm:block">
                <NavLink to="/login">Login</NavLink>
              </Button>
              <Button className="hidden sm:block bg-red-500 hover:bg-red-600">
                <NavLink to="/register">Signup</NavLink>
              </Button>
